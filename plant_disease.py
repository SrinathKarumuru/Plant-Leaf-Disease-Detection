...
train_generator = \
    datagen_train.flow_from_directory(r"D:\Projects\plant_disease_website\dataset\train",
                                      target_size=(48, 48), batch_size=batch_size, class_mode='categorical', shuffle=True)
datagen_validation = ImageDataGenerator(horizontal_flip=True)
validation_generator = \
    datagen_train.flow_from_directory(r"D:\Projects\plant_disease_website\dataset\test",
                                      target_size=(48, 48), batch_size=batch_size, class_mode='categorical', shuffle=True)
